...
class Post3IgWidget extends StatefulWidget {
  const Post3IgWidget({Key? key}) : super(key: key);

  @override
  State<Post3IgWidget> createState() => _Post3IgWidgetState();
}

class _Post3IgWidgetState extends State<Post3IgWidget> {
  late Post3IgWidget _model;
  ...
  void initState() {
    super.initState();
    _model = Post3IgWidget();

    // On page load action.
    SchedulerBinding.instance!.addPostFrameCallback((_) async {
      Navigator.of(context).pushNamed('POST3_IG');
    });
  }
  ...
  onTap: () {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Post4IgWidget()),
    );
  },
  child: Opacity(
    opacity: 0.8,

...
import 'package:wiseapp/pages/Whatsapp/linkd2.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';

class Linkd1Widget extends StatefulWidget {
  const Linkd1Widget({Key? key}) : super(key: key);

  @override
  State<Linkd1Widget> createState() => _Linkd1WidgetState();
}

class _Linkd1WidgetState extends State<Linkd1Widget> {
  @override
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Linkd2Widget()),
                );
              },
              child: Align(

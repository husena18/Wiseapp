...
import 'package:wiseapp/pages/Whatsapp/linkd4.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';


class Linkd3Widget extends StatefulWidget {
  const Linkd3Widget({Key? key}) : super(key: key);

  @override
  State<Linkd3Widget> createState() => _Linkd3WidgetState();
}

class _Linkd3WidgetState extends State<Linkd3Widget> {
  @override
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Linkd4Widget()),
                );
              },
              child: Opacity(
                opacity: 0.8,

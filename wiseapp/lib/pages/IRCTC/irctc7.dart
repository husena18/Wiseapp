...
class IRCTC7Model extends ChangeNotifier {
  late final FocusNode _unfocusNode;

  FocusNode get unfocusNode => _unfocusNode;

  IRCTC7Model() : _unfocusNode = FocusNode();
...
class IRCTC7Widget extends StatefulWidget {
  const IRCTC7Widget({Key? key}) : super(key: key);

  @override
  State<IRCTC7Widget> createState() => _IRCTC7WidgetState();
}

class _IRCTC7WidgetState extends State<IRCTC7Widget>
    with TickerProviderStateMixin {
  late IRCTC7Model _model;

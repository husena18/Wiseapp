...
class log4Model extends ChangeNotifier {
  late final FocusNode _unfocusNode;

  FocusNode get unfocusNode => _unfocusNode;

  log4Model() : _unfocusNode = FocusNode();
...
class log4Widget extends StatefulWidget {
  const log4Widget({Key? key}) : super(key: key);

  @override
  State<log4Widget> createState() => _log4WidgetState();
}

class _log4WidgetState extends State<log4Widget>
    with TickerProviderStateMixin {
  late log4Model _model;

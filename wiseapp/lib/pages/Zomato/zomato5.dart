...
import 'package:wiseapp/pages/Zomato/zomato6.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';


class Zomato5Model extends ChangeNotifier {
  late final FocusNode _unfocusNode;

  FocusNode get unfocusNode => _unfocusNode;

  Zomato5Model() : _unfocusNode = FocusNode();
...
class _Zomato5WidgetState extends State<Zomato5Widget>
  ...
  onTap: () {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Zomato6Widget()),
    );
  },
  child: Opacity(
    opacity: 0.8,

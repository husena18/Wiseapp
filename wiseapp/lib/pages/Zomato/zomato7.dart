...
class Zomato7Model extends ChangeNotifier {
  late final FocusNode _unfocusNode;

  FocusNode get unfocusNode => _unfocusNode;

  Zomato7Model() : _unfocusNode = FocusNode();
...
class Zomato7Widget extends StatefulWidget {
  const Zomato7Widget({Key? key}) : super(key: key);

  @override
  State<Zomato7Widget> createState() => _Zomato7WidgetState();
}

class _Zomato7WidgetState extends State<Zomato7Widget>
    with TickerProviderStateMixin {
  late Zomato7Model _model;
